...
public:
	...
	*/
	enum {
		...
		BUTTON_CONTROLLER_DPAD_RIGHT,
		BUTTON_CONTROLLER_LEFT_TRIGGER,
		BUTTON_CONTROLLER_RIGHT_TRIGGER, // 13
		BUTTON_CONTROLLER_LSTICK_UP,
		BUTTON_CONTROLLER_LSTICK_DOWN,
		BUTTON_CONTROLLER_LSTICK_LEFT,
		BUTTON_CONTROLLER_LSTICK_RIGHT,
		BUTTON_MAX
	};
